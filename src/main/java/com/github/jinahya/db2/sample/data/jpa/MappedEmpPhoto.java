...
public abstract class MappedEmpPhoto<
        SELF extends MappedEmpPhoto<SELF, ID, EMPLOYEE>,
        ID extends MappedEmpPhotoId<ID>,
        EMPLOYEE extends MappedEmployee<EMPLOYEE, ?>>
        extends __MappedEntity<SELF, ID> {

    @Serial
    private static final long serialVersionUID = 746974010325587365L;

    // -----------------------------------------------------------------------------------------------------------------
    public static final String TABLE_NAME = "EMP_PHOTO";

    // ----------------------------------------------------------------------------------------------------------- EMPNO
    public static final String COLUMN_NAME_EMPNO = "EMPNO";

    // ---------------------------------------------------------------------------------------------------- PHOTO_FORMAT
    public static final String COLUMN_NAME_PHOTO_FORMAT = "PHOTO_FORMAT";
    ...
    // ----------------------------------------------------------------------------------------------------- CONSTRUCTOR
    protected MappedEmpPhoto(final Class<ID> idClass) {
        super();
    ...
    @Lob
    @Basic(optional = true)
    @Column(name = COLUMN_NAME_PICTURE, nullable = true, insertable = true, updatable = true)
