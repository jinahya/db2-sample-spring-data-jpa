...
import com.github.jinahya.db2.sample.data.jpa._MappedEntity_DataJpaTest_Configuration;
...
abstract class _MappedEntityRepository_DataJpaTest<
    ...
    // -----------------------------------------------------------------------------------------------------------------
    _MappedEntityRepository_DataJpaTest(final Class<REPOSITORY> repositoryClass, final Class<ENTITY> entityClass) {
        super(repositoryClass, entityClass, Long.class);
    }

    _MappedEntityRepository_DataJpaTest(final Class<REPOSITORY> repositoryClass) {
     ...
     * @see com.github.jinahya.db2.sample.data.jpa._MappedEntity_Persister_Utils#newPersistedInstanceOf(Class,
     * EntityManager)
     */
    @Override
