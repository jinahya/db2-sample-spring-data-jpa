...
abstract class ___MappedEntityRepository_DataJpaTest<
        REPOSITORY extends __MappedEntityRepository<ENTITY, ID>,
        ENTITY extends __MappedEntity<ENTITY, ID>,
        ID extends Serializable> {

    // ---------------------------------------------------------------------------------------------------- CONSTRUCTORS
    ___MappedEntityRepository_DataJpaTest(final Class<REPOSITORY> repositoryClass, final Class<ENTITY> entityClass,
    ...
    <R> R applyEntityManager(final Function<? super EntityManager, ? extends R> function) {
        Objects.requireNonNull(function, "function is null");
        return applyTestEntityManager(tem -> {
